            ...
            {products.map((product, index) => (
              ...
              >
                <div className="relative p-8 text-center">
                  ...
                  <button className="w-full bg-gradient-to-r from-yellow-400 to-orange-400 hover:from-yellow-500 hover:to-orange-500 text-black font-bold py-3 px-6 rounded-2xl transition-all duration-300 transform group-hover:scale-105 shadow-lg">
                    Add to Cart
                  </button>
                </div>
              </div>
